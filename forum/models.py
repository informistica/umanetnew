...
class School(models.Model):
    codice_meccanografico = models.CharField(max_length=14, blank=False)
...
class Classe(models.Model):
    scuola = models.ForeignKey(School, on_delete=models.CASCADE)
    classe = models.CharField(max_length=20)
    cartella = models.CharField(max_length=20)
    posizione = models.IntegerField()
    visibile = models.BooleanField(default=True)
    url_img = models.ImageField(blank=True, null=True)
    url_calendar = models.CharField(max_length=20, blank=True, null=True)  # link al google calendar
    url_feedback = models.CharField(max_length=20, blank=True, null=True)  # link alla pagina feedback nel forum
