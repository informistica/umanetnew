...
class HomeForumView(ListView):
    queryset = Sezione.objects.all()
    template_name = 'forum/homepageforum.html'
...
def cerca(request):
    if "q" in request.GET:
        ...
        return render(request, 'forum/cerca.html', context)
    else:
        return render(request, 'forum/cerca.html')
